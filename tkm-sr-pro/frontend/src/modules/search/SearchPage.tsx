...
const DB_OPTIONS = [
  ...
  { id: 'CINAHL', label: 'CINAHL', color: 'bg-emerald-100 text-emerald-800' },
  { id: 'KMbase', label: 'KMbase (한국의학)', color: 'bg-green-100 text-green-800' },
  { id: 'CiNii', label: 'CiNii (일본학술)', color: 'bg-pink-100 text-pink-800' },
  { id: 'ScienceON', label: 'ScienceON (KISTI)', color: 'bg-cyan-100 text-cyan-800' },
